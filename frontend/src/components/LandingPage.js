...
class LandingPage extends React.Component {
    ...
    render(){
        return(
            ...
            <div className="container2" style={{background: `#fcfcfc url('${require("./sparks_lighter.png")}')`, width: '98.8vw', margin: '0', height: '100vh', backgroundPosition: 'center', backgroundSize: 'cover' }}>
